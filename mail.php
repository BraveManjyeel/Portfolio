...
<html lang="en">
  <head>
    ...
    <title>Manjyeel Khatiwada</title>
      ...
      <div class="w-full container mx-auto">
        <div class="w-full flex items-center justify-between">
          <a class="flex items-center text-indigo-400 no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="#">
            Man<span class="bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-pink-500 to-purple-500">jyeel</span>
          </a>
          <div class="flex w-1/2 justify-end content-center">
            <a class="inline-block text-blue-300 no-underline hover:text-pink-500 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4 transform hover:scale-125 duration-300 ease-in-out" href="https://twitter.com/ManjyeelK">
            ...
            <a
              ...
              href="https://www.facebook.com/marvelmanjyeel/"
            >
              <svg class="fill-current h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
      ...
      <div class="container pt-24 md:pt-36 mx-auto flex flex-wrap flex-col md:flex-row items-center">
       ...
       <br><br><br>
        ...
        <div class="w-full pt-16 pb-6 text-sm text-center md:text-left fade-in">
          ...
          - Website By
          <a class="text-gray-500 no-underline hover:no-underline" href="https://www.manishkhatiwada.com.np">manishkhatiwada.com.np</a>
        </div>
      </div>
    </div>
  </body>
